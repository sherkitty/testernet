...
// amounts 150 .. 63000000
#define NUM_MULTIPLES_150BTC 420000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(     150*COIN,      0x32));
    BOOST_CHECK(TestPair(63000000*COIN, 0x1406f40));
    ...
    for (uint64 i = 1; i <= NUM_MULTIPLES_150BTC; i++)
